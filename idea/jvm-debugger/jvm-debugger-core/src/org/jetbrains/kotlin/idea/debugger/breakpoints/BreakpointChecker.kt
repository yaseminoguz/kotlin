...
class BreakpointChecker {
    ...
    private val breakpointTypes: List<XLineBreakpointType<*>> = XBreakpointType.EXTENSION_POINT_NAME.extensionList
    ...
    fun check(file: KtFile, line: Int): EnumSet<BreakpointType> {
        ...
        for (breakpointType in breakpointTypes) {
            val sign = BREAKPOINT_TYPES[breakpointType.javaClass] ?: error("Unexpected breakpoint type $breakpointType")
