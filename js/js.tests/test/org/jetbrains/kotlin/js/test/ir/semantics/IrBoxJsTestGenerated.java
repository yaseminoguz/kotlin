...
public class IrBoxJsTestGenerated extends AbstractIrBoxJsTest {
    ...
    public static class Regression extends AbstractIrBoxJsTest {
        ...
        public static class StdlibTestSnippets extends AbstractIrBoxJsTest {
            ...
            @TestMetadata("emptyUByteArray.kt")
            public void testEmptyUByteArray() throws Exception {
                runTest("js/js.translator/testData/box/regression/stdlibTestSnippets/emptyUByteArray.kt");
            }
