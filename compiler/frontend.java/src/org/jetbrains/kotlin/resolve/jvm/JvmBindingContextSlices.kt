...
object JvmBindingContextSlices {
    ...
    @JvmField
    val RUNTIME_ASSERTION_INFO_ON_GENERIC_CALL: WritableSlice<CallableDescriptor, RuntimeAssertionInfo> =
        BasicWritableSlice(RewritePolicy.DO_NOTHING)

    @JvmField
    val RUNTIME_ASSERTION_INFO_ON_DELEGATES: WritableSlice<CallableDescriptor, RuntimeAssertionInfo> =
        BasicWritableSlice(RewritePolicy.DO_NOTHING)
