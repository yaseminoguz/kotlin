...
object RuntimeAssertionsOnGenericTypeReturningFunctionsCallChecker : CallChecker {
    override fun check(resolvedCall: ResolvedCall<*>, reportOn: PsiElement, context: CallCheckerContext) {
        ...
        val l = unsubstitutedReturnType.isFlexible()
        val l3 = unsubstitutedReturnType.isNullableUnderlyingType()
        val l4 = unsubstitutedReturnType.hasEnhancedNullability()
        val l5 = unsubstitutedReturnType.isNullabilityFlexible()
