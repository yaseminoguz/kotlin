...
abstract class AbstractTypeApproximator(val ctx: TypeSystemInferenceExtensionContext) : TypeSystemInferenceExtensionContext by ctx {
    ...
    private val cacheForIncorporationConfigToSuperDirection = mutableMapOf<KotlinTypeMarker, ApproximationResult>()
    private val cacheForIncorporationConfigToSubtypeDirection = mutableMapOf<KotlinTypeMarker, ApproximationResult>()
